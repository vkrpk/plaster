...
public class Main implements Tools {
    public static void main(String[] args) {
        ...
        Mutual mutualHealth = new Mutual(1, "Mutual health", "75 peace street",
                "75000", "0142578974", moselle);
        ...
        Doctor doctorDoucet = new Doctor(
         ...
         Specialist specialistLoan = new Specialist(2, "LOAN", "Casimir",
                mutualHealth.generateStringOfNumbers(5), "Metz",
                mutualHealth.generateStringOfNumbers(10), "emailSpecialist@gmail.com",
                cardiologist);
        Customer paul = new Customer(1,
                "OBAMA",
                "Barack",
        ...
        Medication doliprane = new Medication(1, "Medication", 5, LocalDate.now(),
                2000, painkiller);
